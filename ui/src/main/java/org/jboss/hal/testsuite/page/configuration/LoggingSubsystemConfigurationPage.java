...
public class LoggingSubsystemConfigurationPage extends BasePage implements LoggingConfigurationPage {
    ...
    @FindBy(id = "logging-handler-file-table-add-filepath-editing") private WebElement newFileInputElement;
    @FindBy(id = "logging-handler-file-form") private FormFragment fileHandlerForm;
    @FindBy(id = "logging-handler-file-form-filepath-readonly") private WebElement readFileInputElement;
    @FindBy(id = "logging-handler-periodic-rotating-file-table" + WRAPPER) private TableFragment periodicHandlerTable;
    @FindBy(id = "logging-handler-periodic-rotating-file-table-add-filepath-editing") private WebElement newPeriodicFileInputElement;
    @FindBy(id = "logging-handler-periodic-rotating-file-form") private FormFragment periodicHandlerForm;
    @FindBy(id = "logging-handler-periodic-rotating-file-form-filepath-readonly") private WebElement readPeriodicFileInputElement;
    @FindBy(id = "logging-handler-periodic-size-rotating-file-table" + WRAPPER) private TableFragment periodicSizeHandlerTable;
    @FindBy(id = "logging-handler-periodic-size-rotating-file-table-add-filepath-editing") private WebElement newPeriodicSizeFileInputElement;
    @FindBy(id = "logging-handler-periodic-size-rotating-file-form") private FormFragment periodicSizeHandlerForm;
    @FindBy(id = "logging-handler-periodic-size-rotating-file-form-filepath-readonly") private WebElement readPeriodicSizeFileInputElement;
    @FindBy(id = "logging-handler-size-rotating-file-table" + WRAPPER) private TableFragment sizeHandlerTable;
    @FindBy(id = "logging-handler-size-rotating-file-table-add-filepath-editing") private WebElement newSizeFileInputElement;
    @FindBy(id = "logging-handler-size-rotating-file-form") private FormFragment sizeHandlerForm;
    @FindBy(id = "logging-handler-size-rotating-file-form-filepath-readonly") private WebElement readSizeFileInputElement;
