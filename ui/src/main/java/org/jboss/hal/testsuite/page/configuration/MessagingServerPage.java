...
import static org.jboss.hal.resources.Ids.MESSAGING_SERVER_BINDING_DIRECTORY_FORM;
import static org.jboss.hal.resources.Ids.MESSAGING_SERVER_JOURNAL_DIRECTORY_FORM;
import static org.jboss.hal.resources.Ids.MESSAGING_SERVER_LARGE_MESSAGES_DIRECTORY_FORM;
import static org.jboss.hal.resources.Ids.MESSAGING_SERVER_PAGING_DIRECTORY_FORM;
...
public class MessagingServerPage extends BasePage {
    ...
    @FindBy(id = MESSAGING_SERVER + "-cluster-credential-reference-"
            + FORM) private FormFragment clusterCredentialReferenceForm;
    @FindBy(id = MESSAGING_SERVER + "-cluster-credential-reference-" + FORM + "-"
            + EMPTY) private EmptyState clusterCredentialReferenceEmptyState;
