...
public class MessagingJmsBridgePage extends BasePage {
    ...
    @FindBy(id = JMS_BRIDGE + "-" + SOURCE_CREDENTIAL_REFERENCE + "-"
            + FORM) private FormFragment sourceCredentialReferenceForm;
    @FindBy(id = JMS_BRIDGE + "-" + TARGET_CREDENTIAL_REFERENCE + "-"
            + FORM) private FormFragment targetCredentialReferenceForm;
