...
public class DistributableWebPage extends BasePage {
    ...
    public SelectFragment getSwitchAffinity() {
        WebElement element = getRootContainer()
                .findElement(By.cssSelector("#dw-infinispan-session-management-affinity-tab .header-form ." + bootstrapSelect));
        if (element != null) {
    ...
    public SelectFragment getSwitchRouting() {
        WebElement element = getRootContainer()
                .findElement(By.cssSelector("section[data-vn-item-for=dw-routing-item] .header-form ." + bootstrapSelect));
        if (element != null) {
            return Graphene.createPageFragment(SelectFragment.class, element);
        }
        return null;
