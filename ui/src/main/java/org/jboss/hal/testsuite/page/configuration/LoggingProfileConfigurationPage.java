...
public class LoggingProfileConfigurationPage extends BasePage implements LoggingConfigurationPage {
    ...
    @FindBy(id = "logging-profile-handler-file-table-add-filepath-editing") private WebElement newFileInputElement;
    @FindBy(id = "logging-profile-handler-file-form") private FormFragment fileHandlerForm;
    @FindBy(id = "logging-profile-handler-file-form-filepath-readonly") private WebElement readFileInputElement;
    @FindBy(id = "logging-profile-handler-periodic-rotating-file-table" + WRAPPER) private TableFragment periodicHandlerTable;
    @FindBy(id = "logging-profile-handler-periodic-rotating-file-table-add-filepath-editing") private WebElement newPeriodicFileInputElement;
    @FindBy(id = "logging-profile-handler-periodic-rotating-file-form") private FormFragment periodicHandlerForm;
    @FindBy(id = "logging-profile-handler-periodic-rotating-file-form-filepath-readonly") private WebElement readPeriodicFileInputElement;
    @FindBy(id = "logging-profile-handler-periodic-size-rotating-file-table"
            + WRAPPER) private TableFragment periodicSizeHandlerTable;
    @FindBy(id = "logging-profile-handler-periodic-size-rotating-file-table-add-filepath-editing") private WebElement newPeriodicSizeFileInputElement;
    @FindBy(id = "logging-profile-handler-periodic-size-rotating-file-form") private FormFragment periodicSizeHandlerForm;
    @FindBy(id = "logging-profile-handler-periodic-size-rotating-file-form-filepath-readonly") private WebElement readPeriodicSizeFileInputElement;
    @FindBy(id = "logging-profile-handler-size-rotating-file-table" + WRAPPER) private TableFragment sizeHandlerTable;
    @FindBy(id = "logging-profile-handler-size-rotating-file-table-add-filepath-editing") private WebElement newSizeFileInputElement;
    @FindBy(id = "logging-profile-handler-size-rotating-file-form") private FormFragment sizeHandlerForm;
    @FindBy(id = "logging-profile-handler-size-rotating-file-form-filepath-readonly") private WebElement readSizeFileInputElement;
