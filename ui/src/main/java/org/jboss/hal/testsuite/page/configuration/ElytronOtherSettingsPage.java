...
import static org.jboss.hal.resources.Ids.ELYTRON_AGGREGATE_PROVIDERS;
import static org.jboss.hal.resources.Ids.ELYTRON_AGGREGATE_SECURITY_EVENT_LISTENER;
import static org.jboss.hal.resources.Ids.ELYTRON_AUTHENTICATION_CONFIGURATION;
import static org.jboss.hal.resources.Ids.ELYTRON_AUTHENTICATION_CONTEXT;
import static org.jboss.hal.resources.Ids.ELYTRON_CERTIFICATE_AUTHORITY;
import static org.jboss.hal.resources.Ids.ELYTRON_CERTIFICATE_AUTHORITY_ACCOUNT;
...
import static org.jboss.hal.resources.Ids.ELYTRON_CUSTOM_POLICY_FORM;
import static org.jboss.hal.resources.Ids.ELYTRON_CUSTOM_SECURITY_EVENT_LISTENER;
import static org.jboss.hal.resources.Ids.ELYTRON_DIR_CONTEXT;
import static org.jboss.hal.resources.Ids.ELYTRON_FILE_AUDIT_LOG;
import static org.jboss.hal.resources.Ids.ELYTRON_FILTERING_KEY_STORE;
import static org.jboss.hal.resources.Ids.ELYTRON_JACC_POLICY_FORM;
import static org.jboss.hal.resources.Ids.ELYTRON_JASPI;
...
import static org.jboss.hal.resources.Ids.ELYTRON_PERIODIC_ROTATING_FILE_AUDIT_LOG;
import static org.jboss.hal.resources.Ids.ELYTRON_PROVIDER_LOADER;
import static org.jboss.hal.resources.Ids.ELYTRON_SECURITY_DOMAIN;
import static org.jboss.hal.resources.Ids.ELYTRON_SERVER_SSL_CONTEXT;
import static org.jboss.hal.resources.Ids.ELYTRON_SIZE_ROTATING_FILE_AUDIT_LOG;
import static org.jboss.hal.resources.Ids.ELYTRON_SYSLOG_AUDIT_LOG;
...
public class ElytronOtherSettingsPage extends BasePage {
    ...
    @FindBy(id = ELYTRON_CREDENTIAL_STORE + "-" + CREDENTIAL_REFERENCE + "-"
            + FORM) private FormFragment credentialStoreCredentialReferenceForm;
    ...
    @FindBy(id = ELYTRON_KEY_STORE + "-" + CREDENTIAL_REFERENCE + "-"
            + FORM) private FormFragment keyStoreCredentialReferenceForm;
    ...
    @FindBy(id = ELYTRON_LDAP_KEY_STORE + "-" + NEW_ITEM_TEMPLATE + "-"
            + FORM) private FormFragment ldapKeyStoreNewItemTemplateForm;
    ...
    @FindBy(id = ELYTRON_KEY_MANAGER + "-" + CREDENTIAL_REFERENCE + "-"
            + FORM) private FormFragment keyManagerCredentialReferenceForm;
    ...
    @FindBy(id = ELYTRON_SECURITY_DOMAIN + "-" + REALMS + "-" + TABLE
            + WRAPPER) private TableFragment securityDomainRealmsTable;
    ...
    @FindBy(id = ELYTRON_AUTHENTICATION_CONFIGURATION + "-" + TABLE
            + WRAPPER) private TableFragment authenticationConfigurationTable;
    @FindBy(id = ELYTRON_AUTHENTICATION_CONFIGURATION + "-"
            + TAB_CONTAINER) private TabsFragment authenticationConfigurationTabs;
    @FindBy(id = ELYTRON_AUTHENTICATION_CONFIGURATION + "-" + FORM) private FormFragment authenticationConfigurationForm;
    @FindBy(id = ELYTRON_AUTHENTICATION_CONFIGURATION + "-" + CREDENTIAL_REFERENCE + "-"
            + FORM) private FormFragment authConfigCredentialReferenceForm;
    ...
    @FindBy(id = ELYTRON_AUTHENTICATION_CONTEXT + "-match-rules-" + TABLE
            + WRAPPER) private TableFragment authenticationContextMatchRulesTable;
    @FindBy(id = ELYTRON_AUTHENTICATION_CONTEXT + "-match-rules-"
            + FORM) private FormFragment authenticationContextMatchRulesForm;
    ...
    @FindBy(id = ELYTRON_PERIODIC_ROTATING_FILE_AUDIT_LOG + "-" + TABLE
            + WRAPPER) private TableFragment periodicRotatingFileAuditLogTable;
    ...
    @FindBy(id = ELYTRON_SIZE_ROTATING_FILE_AUDIT_LOG + "-" + TABLE
            + WRAPPER) private TableFragment sizeRotatingFileAuditLogTable;
    ...
    @FindBy(id = ELYTRON_AGGREGATE_SECURITY_EVENT_LISTENER + "-" + TABLE
            + WRAPPER) private TableFragment aggregateSecurityEventListenerTable;
    @FindBy(id = ELYTRON_AGGREGATE_SECURITY_EVENT_LISTENER + "-"
            + FORM) private FormFragment aggregateSecurityEventListenerForm;
    ...
    @FindBy(id = ELYTRON_DIR_CONTEXT + "-" + CREDENTIAL_REFERENCE + "-"
            + FORM) private FormFragment dirContextCredentialReferenceForm;
    @FindBy(id = ELYTRON_DIR_CONTEXT + "-" + TAB_CONTAINER) private TabsFragment dirContextTabs;

    // certificate authority
    @FindBy(id = ELYTRON_CERTIFICATE_AUTHORITY + "-" + TABLE + WRAPPER) private TableFragment certificateAuthorityTable;
    @FindBy(id = ELYTRON_CERTIFICATE_AUTHORITY + "-" + FORM) private FormFragment certificateAuthorityForm;

    // certificate authority account
    @FindBy(id = ELYTRON_CERTIFICATE_AUTHORITY_ACCOUNT + "-" + TABLE
            + WRAPPER) private TableFragment certificateAuthorityAccountTable;
    @FindBy(id = ELYTRON_CERTIFICATE_AUTHORITY_ACCOUNT + "-" + FORM) private FormFragment certificateAuthorityAccountForm;
    @FindBy(id = ELYTRON_CERTIFICATE_AUTHORITY_ACCOUNT + "-" + TAB_CONTAINER) private TabsFragment certificateAuthorityTabs;
    @FindBy(id = ELYTRON_CERTIFICATE_AUTHORITY_ACCOUNT + "-" + CREDENTIAL_REFERENCE + "-"
            + FORM) private FormFragment certificateAuthorityAccountCredentialReferenceForm;

    // custom security event listener
    @FindBy(id = ELYTRON_CUSTOM_SECURITY_EVENT_LISTENER + "-" + TABLE
            + WRAPPER) private TableFragment customSecurityEventListenerTable;
    @FindBy(id = ELYTRON_CUSTOM_SECURITY_EVENT_LISTENER + "-" + FORM) private FormFragment customSecurityEventListenerForm;

    // jaspi
    @FindBy(id = ELYTRON_JASPI + "-" + TABLE + WRAPPER) private TableFragment jaspiConfigurationTable;
    @FindBy(id = ELYTRON_JASPI + "-" + FORM) private FormFragment jaspiConfigurationForm;
    @FindBy(id = ELYTRON_JASPI + "-" + "server-auth-modules" + "-" + TABLE
            + WRAPPER) private TableFragment jaspiServerAuthModulesTable;
    @FindBy(id = ELYTRON_JASPI + "-" + "server-auth-modules" + "-" + FORM) private FormFragment jaspiServerAuthModulesForm;
