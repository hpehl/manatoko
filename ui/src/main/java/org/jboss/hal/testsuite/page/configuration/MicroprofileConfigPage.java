...
public class MicroprofileConfigPage extends BasePage {
    ...
    @FindBy(id = "microprofile-config-source-table_wrapper") private TableFragment configSourcesTable;

    @FindBy(id = "microprofile-config-source-provider-table_wrapper") private TableFragment configProvidersTable;

    @FindBy(id = "microprofile-config-source-form") private FormFragment configSourceForm;

    @FindBy(id = "microprofile-config-source-provider-form") private FormFragment configProviderForm;
