...
public class UndertowHandlersPage extends BasePage {
    ...
    @FindBy(id = "undertow-file-handler-table_wrapper") private TableFragment fileHandlerTable;

    @FindBy(id = "undertow-file-handler-form") private FormFragment fileHandlerForm;

    @FindBy(id = "undertow-reverse-proxy-table_wrapper") private TableFragment reverseProxyTable;

    @FindBy(id = "undertow-reverse-proxy-form") private FormFragment reverseProxyForm;
