...
public class MessagingServerConnectionsPage extends BasePage {
    ...
    @FindBy(id = MESSAGING_SERVER + "-" + POOLED_CONNECTION_FACTORY + "-" + TABLE
            + WRAPPER) private TableFragment pooledConnectionFactoryTable;
    ...
    @FindBy(id = MESSAGING_SERVER + "-" + CREDENTIAL_REFERENCE + "-" + FORM + "-"
            + EMPTY) private EmptyState pooledConnectionFactoryCREmptyState;
