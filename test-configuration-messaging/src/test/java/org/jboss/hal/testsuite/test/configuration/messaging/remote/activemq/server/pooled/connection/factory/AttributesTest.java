...
class AttributesTest extends AbstractPooledConnectionFactoryTest {
    ...
    static void setupModel() throws Exception {
        ...
        createDiscoveryGroup(operations, DISCOVERY_GROUP_UPDATE, JGROUPS_CHANNEL);
        new Administration(client).reloadIfRequired();
        createPooledConnectionFactory(operations, POOLED_CONNECTION_FACTORY_UPDATE, DISCOVERY_GROUP_CREATE);
        createGenericConnector(operations, GENERIC_CONNECTOR_UPDATE);
    }
    ...
    public void editConnectors() throws Exception {
        crudOperations.update(RemoteActiveMQServer.pooledConnectionFactoryAddress(POOLED_CONNECTION_FACTORY_UPDATE),
                ...
                resourceVerifier -> resourceVerifier.verifyListAttributeContainsValue("connectors",
                        GENERIC_CONNECTOR_UPDATE));
    }
    ...
    public void editEntries() throws Exception {
        crudOperations.update(RemoteActiveMQServer.pooledConnectionFactoryAddress(POOLED_CONNECTION_FACTORY_UPDATE),
                page.getPooledConnectionFactoryForm(), "entries",
                Arrays.asList(Random.name(), Random.name(), Random.name()));
    }
