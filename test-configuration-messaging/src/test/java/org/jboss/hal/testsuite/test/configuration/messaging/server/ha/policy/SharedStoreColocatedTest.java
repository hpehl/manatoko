...
@Manatoko
@Testcontainers
class SharedStoreColocatedTest extends AbstractHaPolicyTest {
    ...
    void editMaxBackups() throws Exception {
        crudOperations.update(HAPolicy.SHARED_STORE_COLOCATED.haPolicyAddress, page.getSharedStoreColocatedForm(),
                "max-backups",
                Random.number());
    }
