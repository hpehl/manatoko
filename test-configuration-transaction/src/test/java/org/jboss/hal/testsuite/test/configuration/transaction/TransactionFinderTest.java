...
class TransactionFinderTest {
    ...
    void view() {
        console.finder(NameTokens.CONFIGURATION, new FinderPath().append(Ids.CONFIGURATION, Ids.asId(Names.SUBSYSTEMS)))
                .column(Ids.CONFIGURATION_SUBSYSTEM).selectItem(NameTokens.TRANSACTIONS).view();
        console.verify(new PlaceRequest.Builder().nameToken(NameTokens.TRANSACTIONS).build());
    }
}
