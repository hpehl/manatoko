...
public final class RemotingFixtures {
    ...
    public static final String HTTP_CONNECTOR_CREATE = Ids.build(HTTP_CONNECTOR_PREFIX, CONNECTOR_PREFIX, CrudConstants.CREATE,
            Random.name());
    public static final String HTTP_CONNECTOR_READ = Ids.build(HTTP_CONNECTOR_PREFIX, CONNECTOR_PREFIX, CrudConstants.READ,
            Random.name());
    public static final String HTTP_CONNECTOR_UPDATE = Ids.build(HTTP_CONNECTOR_PREFIX, CONNECTOR_PREFIX, CrudConstants.UPDATE,
            Random.name());
    public static final String HTTP_CONNECTOR_DELETE = Ids.build(HTTP_CONNECTOR_PREFIX, CONNECTOR_PREFIX, CrudConstants.DELETE,
            Random.name());
    public static final String HTTP_CONNECTOR_SECURITY = Ids.build(HTTP_CONNECTOR_PREFIX, CONNECTOR_PREFIX, SECURITY,
            Random.name());
    public static final String HTTP_CONNECTOR_POLICY = Ids.build(HTTP_CONNECTOR_PREFIX, CONNECTOR_PREFIX, POLICY,
            Random.name());
    ...
    public static final String HTTP_CONNECTOR_CREATE_SOCKET = Ids.build(HTTP_CONNECTOR_PREFIX, CONNECTOR_PREFIX,
            CrudConstants.CREATE, SOCKET, Random.name());
    public static final String HTTP_CONNECTOR_READ_SOCKET = Ids.build(HTTP_CONNECTOR_PREFIX, CONNECTOR_PREFIX,
            CrudConstants.READ, SOCKET, Random.name());
    public static final String HTTP_CONNECTOR_UPDATE_SOCKET = Ids.build(HTTP_CONNECTOR_PREFIX, CONNECTOR_PREFIX,
            CrudConstants.UPDATE, SOCKET, Random.name());
    public static final String HTTP_CONNECTOR_DELETE_SOCKET = Ids.build(HTTP_CONNECTOR_PREFIX, CONNECTOR_PREFIX,
            CrudConstants.DELETE, SOCKET, Random.name());
    public static final String HTTP_CONNECTOR_SECURITY_SOCKET = Ids.build(HTTP_CONNECTOR_PREFIX, CONNECTOR_PREFIX, SECURITY,
            SOCKET, Random.name());
    public static final String HTTP_CONNECTOR_POLICY_SOCKET = Ids.build(HTTP_CONNECTOR_PREFIX, CONNECTOR_PREFIX, POLICY, SOCKET,
            Random.name());

    // ------------------------------------------------------ http listener for http connector

    public static final String HTTP_CONNECTOR_CREATE_LISTENER = Ids.build(HTTP_CONNECTOR_PREFIX, CONNECTOR_PREFIX,
            CrudConstants.CREATE, LISTENER, Random.name());
    public static final String HTTP_CONNECTOR_READ_LISTENER = Ids.build(HTTP_CONNECTOR_PREFIX, CONNECTOR_PREFIX,
            CrudConstants.READ, LISTENER, Random.name());
    public static final String HTTP_CONNECTOR_UPDATE_LISTENER = Ids.build(HTTP_CONNECTOR_PREFIX, CONNECTOR_PREFIX,
            CrudConstants.UPDATE, LISTENER, Random.name());
    public static final String HTTP_CONNECTOR_DELETE_LISTENER = Ids.build(HTTP_CONNECTOR_PREFIX, CONNECTOR_PREFIX,
            CrudConstants.DELETE, LISTENER, Random.name());
    public static final String HTTP_CONNECTOR_SECURITY_LISTENER = Ids.build(HTTP_CONNECTOR_PREFIX, CONNECTOR_PREFIX, SECURITY,
            LISTENER, Random.name());
    public static final String HTTP_CONNECTOR_POLICY_LISTENER = Ids.build(HTTP_CONNECTOR_PREFIX, CONNECTOR_PREFIX, POLICY,
            LISTENER, Random.name());
