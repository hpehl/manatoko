...
public final class SocketBindingFixtures {
    ...
    public static final String SBG_CREATE = Ids.build(SOCKET_BINDING_GROUP_PREFIX, CrudConstants.CREATE, Random.name());
    public static final String SBG_READ = Ids.build(SOCKET_BINDING_GROUP_PREFIX, CrudConstants.READ, Random.name());
    public static final String SBG_UPDATE = Ids.build(SOCKET_BINDING_GROUP_PREFIX, CrudConstants.UPDATE, Random.name());
    public static final String SBG_DELETE = Ids.build(SOCKET_BINDING_GROUP_PREFIX, CrudConstants.DELETE, Random.name());

    public static Address socketBindingGroupAddress(String name) {
    ...
    public static final String INBOUND_CREATE = Ids.build(A_PREFIX, INBOUND, CrudConstants.CREATE, Random.name());
    public static final String INBOUND_READ = Ids.build(A_PREFIX, INBOUND, CrudConstants.READ, Random.name());
    public static final String INBOUND_UPDATE = Ids.build(A_PREFIX, INBOUND, CrudConstants.UPDATE, Random.name());
    public static final String INBOUND_DELETE = Ids.build(A_PREFIX, INBOUND, CrudConstants.DELETE, Random.name());
    ...
    public static final String OUTBOUND_LOCAL_CREATE = Ids.build(OUTBOUND_PREFIX, LOCAL, CrudConstants.CREATE, Random.name());
    public static final String OUTBOUND_LOCAL_READ = Ids.build(OUTBOUND_PREFIX, LOCAL, CrudConstants.READ, Random.name());
    public static final String OUTBOUND_LOCAL_UPDATE = Ids.build(OUTBOUND_PREFIX, LOCAL, CrudConstants.UPDATE, Random.name());
    public static final String OUTBOUND_LOCAL_DELETE = Ids.build(OUTBOUND_PREFIX, LOCAL, CrudConstants.DELETE, Random.name());

    public static Address outboundLocalAddress(String sbg, String name) {
    ...
    public static final String OUTBOUND_REMOTE_UPDATE = Ids.build(OUTBOUND_PREFIX, REMOTE, CrudConstants.UPDATE, Random.name());
    public static final String OUTBOUND_REMOTE_DELETE = Ids.build(OUTBOUND_PREFIX, REMOTE, CrudConstants.DELETE, Random.name());

    public static Address outboundRemoteAddress(String sbg, String name) {
