...
public final class LoggingFixtures {
    ...
    public static class ConsoleHandler {
        ...
        public static final String CONSOLE_HANDLER_CREATE = Ids.build(CONSOLE_HANDLER_PREFIX, CrudConstants.CREATE,
                Random.name());
        public static final String CONSOLE_HANDLER_UPDATE = Ids.build(CONSOLE_HANDLER_PREFIX, CrudConstants.UPDATE,
                Random.name());
        public static final String CONSOLE_HANDLER_DELETE = Ids.build(CONSOLE_HANDLER_PREFIX, CrudConstants.DELETE,
                Random.name());
    ...
    public static class PeriodicHandler {
        ...
        public static final String PERIODIC_HANDLER_CREATE = Ids.build(PERIODIC_HANDLER_PREFIX, CrudConstants.CREATE,
                Random.name());
        public static final String PERIODIC_HANDLER_READ = Ids.build(PERIODIC_HANDLER_PREFIX, CrudConstants.READ,
                Random.name());
        public static final String PERIODIC_HANDLER_UPDATE = Ids.build(PERIODIC_HANDLER_PREFIX, CrudConstants.UPDATE,
                Random.name());
        public static final String PERIODIC_HANDLER_DELETE = Ids.build(PERIODIC_HANDLER_PREFIX, CrudConstants.DELETE,
                Random.name());
    ...
    public static class PeriodicSizeHandler {
        ...
        public static final String PERIODIC_SIZE_HANDLER_CREATE = Ids.build(PERIODIC_SIZE_HANDLER_PREFIX, CrudConstants.CREATE,
                Random.name());
        public static final String PERIODIC_SIZE_HANDLER_READ = Ids.build(PERIODIC_SIZE_HANDLER_PREFIX, CrudConstants.READ,
                Random.name());
        public static final String PERIODIC_SIZE_HANDLER_UPDATE = Ids.build(PERIODIC_SIZE_HANDLER_PREFIX, CrudConstants.UPDATE,
                Random.name());
        public static final String PERIODIC_SIZE_HANDLER_DELETE = Ids.build(PERIODIC_SIZE_HANDLER_PREFIX, CrudConstants.DELETE,
                Random.name());
    ...
    public static class CustomHandler {
        ...
        public static final String CUSTOM_HANDLER_CREATE = Ids.build(CUSTOM_HANDLER_PREFIX, CrudConstants.CREATE,
                Random.name());
        public static final String CUSTOM_HANDLER_READ = Ids.build(CUSTOM_HANDLER_PREFIX, CrudConstants.READ, Random.name());
        public static final String CUSTOM_HANDLER_UPDATE = Ids.build(CUSTOM_HANDLER_PREFIX, CrudConstants.UPDATE,
                Random.name());
        public static final String CUSTOM_HANDLER_DELETE = Ids.build(CUSTOM_HANDLER_PREFIX, CrudConstants.DELETE,
                Random.name());
    ...
    public static class SocketHandler {
        ...
        public static final String SOCKET_HANDLER_CREATE = Ids.build(SOCKET_HANDLER_PREFIX, CrudConstants.CREATE,
                Random.name());
        public static final String SOCKET_HANDLER_UPDATE = Ids.build(SOCKET_HANDLER_PREFIX, CrudConstants.UPDATE,
                Random.name());
        public static final String SOCKET_HANDLER_DELETE = Ids.build(SOCKET_HANDLER_PREFIX, CrudConstants.DELETE,
                Random.name());
    ...
    public static class SyslogHandler {
        ...
        public static final String SYSLOG_HANDLER_CREATE = Ids.build(SYSLOG_HANDLER_PREFIX, CrudConstants.CREATE,
                Random.name());
        public static final String SYSLOG_HANDLER_UPDATE = Ids.build(SYSLOG_HANDLER_PREFIX, CrudConstants.UPDATE,
                Random.name());
        public static final String SYSLOG_HANDLER_DELETE = Ids.build(SYSLOG_HANDLER_PREFIX, CrudConstants.DELETE,
                Random.name());
    ...
    public static class PatternFormatter {
        ...
        public static final String PATTERN_FORMATTER_CREATE = Ids.build(PATTERN_FORMATTER_PREFIX, CrudConstants.CREATE,
                Random.name());
        public static final String PATTERN_FORMATTER_UPDATE = Ids.build(PATTERN_FORMATTER_PREFIX, CrudConstants.UPDATE,
                Random.name());
        public static final String PATTERN_FORMATTER_DELETE = Ids.build(PATTERN_FORMATTER_PREFIX, CrudConstants.DELETE,
                Random.name());
    ...
    public static class JsonFormatter {
        ...
        public static final String JSON_FORMATTER_CREATE = Ids.build(JSON_FORMATTER_PREFIX, CrudConstants.CREATE,
                Random.name());
        public static final String JSON_FORMATTER_UPDATE = Ids.build(JSON_FORMATTER_PREFIX, CrudConstants.UPDATE,
                Random.name());
        public static final String JSON_FORMATTER_RESET = Ids.build(JSON_FORMATTER_PREFIX, CrudConstants.RESET, Random.name());
        public static final String JSON_FORMATTER_DELETE = Ids.build(JSON_FORMATTER_PREFIX, CrudConstants.DELETE,
                Random.name());
    ...
    public static class CustomFormatter {
        ...
        public static final String CUSTOM_FORMATTER_CREATE = Ids.build(CUSTOM_FORMATTER_PREFIX, CrudConstants.CREATE,
                Random.name());
        public static final String CUSTOM_FORMATTER_UPDATE = Ids.build(CUSTOM_FORMATTER_PREFIX, CrudConstants.UPDATE,
                Random.name());
        public static final String CUSTOM_FORMATTER_RESET = Ids.build(CUSTOM_FORMATTER_PREFIX, CrudConstants.RESET,
                Random.name());
        public static final String CUSTOM_FORMATTER_DELETE = Ids.build(CUSTOM_FORMATTER_PREFIX, CrudConstants.DELETE,
                Random.name());
