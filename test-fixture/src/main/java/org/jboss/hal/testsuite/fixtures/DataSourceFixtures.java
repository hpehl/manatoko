...
public final class DataSourceFixtures {
    ...
    public static final String DATA_SOURCE_CREATE_TEST_CANCEL = Ids.build(DATA_SOURCE_PREFIX, "create-test-cancel",
            Random.name());
    public static final String DATA_SOURCE_CREATE_TEST_CHANGE = Ids.build(DATA_SOURCE_PREFIX, "create-test-change",
            Random.name());
    public static final String DATA_SOURCE_CREATE_TEST_FINISH = Ids.build(DATA_SOURCE_PREFIX, "create-test-finish",
            Random.name());
