...
public final class EEFixtures {
    ...
    public static final String SCHEDULED_EXECUTOR_CREATE = Ids.build(SCHEDULED_EXECUTOR_PREFIX, CrudConstants.CREATE,
            Random.name());
    public static final String SCHEDULED_EXECUTOR_READ = Ids.build(SCHEDULED_EXECUTOR_PREFIX, CrudConstants.READ,
            Random.name());
    public static final String SCHEDULED_EXECUTOR_UPDATE = Ids.build(SCHEDULED_EXECUTOR_PREFIX, CrudConstants.UPDATE,
            Random.name());
    public static final String SCHEDULED_EXECUTOR_DELETE = Ids.build(SCHEDULED_EXECUTOR_PREFIX, CrudConstants.DELETE,
            Random.name());
