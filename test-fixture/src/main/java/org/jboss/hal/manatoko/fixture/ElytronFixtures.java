...
import static org.jboss.hal.dmr.ModelDescriptionConstants.AGGREGATE_PRINCIPAL_TRANSFORMER;
import static org.jboss.hal.dmr.ModelDescriptionConstants.AGGREGATE_PROVIDERS;
import static org.jboss.hal.dmr.ModelDescriptionConstants.AGGREGATE_REALM;
import static org.jboss.hal.dmr.ModelDescriptionConstants.AGGREGATE_ROLE_MAPPER;
import static org.jboss.hal.dmr.ModelDescriptionConstants.AGGREGATE_SASL_SERVER_FACTORY;
import static org.jboss.hal.dmr.ModelDescriptionConstants.AGGREGATE_SECURITY_EVENT_LISTENER;
import static org.jboss.hal.dmr.ModelDescriptionConstants.AUTHENTICATION_CONFIGURATION;
import static org.jboss.hal.dmr.ModelDescriptionConstants.AUTHENTICATION_CONTEXT;
import static org.jboss.hal.dmr.ModelDescriptionConstants.CACHING_REALM;
import static org.jboss.hal.dmr.ModelDescriptionConstants.CHAINED_PRINCIPAL_TRANSFORMER;
...
import static org.jboss.hal.dmr.ModelDescriptionConstants.CONFIGURABLE_SASL_SERVER_FACTORY;
...
import static org.jboss.hal.dmr.ModelDescriptionConstants.CONSTANT_PRINCIPAL_TRANSFORMER;
import static org.jboss.hal.dmr.ModelDescriptionConstants.CONSTANT_REALM_MAPPER;
...
import static org.jboss.hal.dmr.ModelDescriptionConstants.CUSTOM_MODIFIABLE_REALM;
import static org.jboss.hal.dmr.ModelDescriptionConstants.CUSTOM_PRINCIPAL_TRANSFORMER;
import static org.jboss.hal.dmr.ModelDescriptionConstants.CUSTOM_REALM;
import static org.jboss.hal.dmr.ModelDescriptionConstants.CUSTOM_REALM_MAPPER;
...
import static org.jboss.hal.dmr.ModelDescriptionConstants.FILE_AUDIT_LOG;
import static org.jboss.hal.dmr.ModelDescriptionConstants.FILTERING_KEY_STORE;
import static org.jboss.hal.dmr.ModelDescriptionConstants.HTTP_AUTHENTICATION_FACTORY;
import static org.jboss.hal.dmr.ModelDescriptionConstants.IDENTITY_REALM;
import static org.jboss.hal.dmr.ModelDescriptionConstants.JDBC_REALM;
import static org.jboss.hal.dmr.ModelDescriptionConstants.KERBEROS_SECURITY_FACTORY;
...
import static org.jboss.hal.dmr.ModelDescriptionConstants.KEY_STORE_REALM;
import static org.jboss.hal.dmr.ModelDescriptionConstants.LDAP_KEY_STORE;
...
import static org.jboss.hal.dmr.ModelDescriptionConstants.MAPPED_REGEX_REALM_MAPPER;
import static org.jboss.hal.dmr.ModelDescriptionConstants.MECHANISM_PROVIDER_FILTERING_SASL_SERVER_FACTORY;
import static org.jboss.hal.dmr.ModelDescriptionConstants.PERIODIC_ROTATING_FILE_AUDIT_LOG;
...
import static org.jboss.hal.dmr.ModelDescriptionConstants.PROVIDER_LOADER;
import static org.jboss.hal.dmr.ModelDescriptionConstants.PROVIDER_SASL_SERVER_FACTORY;
import static org.jboss.hal.dmr.ModelDescriptionConstants.REGEX_PRINCIPAL_TRANSFORMER;
import static org.jboss.hal.dmr.ModelDescriptionConstants.REGEX_VALIDATING_PRINCIPAL_TRANSFORMER;
import static org.jboss.hal.dmr.ModelDescriptionConstants.SASL_AUTHENTICATION_FACTORY;
...
import static org.jboss.hal.dmr.ModelDescriptionConstants.SERVICE_LOADER_HTTP_SERVER_MECHANISM_FACTORY;
import static org.jboss.hal.dmr.ModelDescriptionConstants.SERVICE_LOADER_SASL_SERVER_FACTORY;
import static org.jboss.hal.dmr.ModelDescriptionConstants.SIMPLE_PERMISSION_MAPPER;
import static org.jboss.hal.dmr.ModelDescriptionConstants.SIMPLE_REGEX_REALM_MAPPER;
import static org.jboss.hal.dmr.ModelDescriptionConstants.SIMPLE_ROLE_DECODER;
import static org.jboss.hal.dmr.ModelDescriptionConstants.SIZE_ROTATING_FILE_AUDIT_LOG;
...
public final class ElytronFixtures {
    ...
    public static final String AGGREGATE_HTTP_SERVER_MECHANISM_FACTORY_ITEM = Ids.build(
            Ids.ELYTRON_AGGREGATE_HTTP_SERVER_MECHANISM_FACTORY, Ids.ITEM);
    public static final String AGGREGATE_PRINCIPAL_DECODER_ITEM = "mappers-decoders-aggregate-principal-decoder-item";
    public static final String AGGREGATE_PRINCIPAL_TRANSFORMER_ITEM = Ids.build(
            Ids.ELYTRON_AGGREGATE_PRINCIPAL_TRANSFORMER, Ids.ITEM);
    ...
    public static final String AGGREGATE_SASL_SERVER_FACTORY_ITEM = Ids.build(Ids.ELYTRON_AGGREGATE_SASL_SERVER_FACTORY,
            Ids.ITEM);
    ...
    public static final String CHAINED_PRINCIPAL_TRANSFORMER_ITEM = Ids.build(Ids.ELYTRON_CHAINED_PRINCIPAL_TRANSFORMER,
            Ids.ITEM);
    ...
    public static final String CONFIGURABLE_HTTP_SERVER_MECHANISM_FACTORY_ITEM = Ids.build(
            Ids.ELYTRON_CONFIGURABLE_HTTP_SERVER_MECHANISM_FACTORY, Ids.ITEM);
    public static final String CONFIGURABLE_SASL_SERVER_FACTORY_ITEM = Ids.build(
            Ids.ELYTRON_CONFIGURABLE_SASL_SERVER_FACTORY,
            Ids.ITEM);
    ...
    public static final String CONSTANT_PRINCIPAL_TRANSFORMER_ITEM = Ids.build(
            Ids.ELYTRON_CONSTANT_PRINCIPAL_TRANSFORMER, Ids.ITEM);
    ...
    public static final String CUSTOM_PRINCIPAL_TRANSFORMER_ITEM = Ids.build(Ids.ELYTRON_CUSTOM_PRINCIPAL_TRANSFORMER,
            Ids.ITEM);
    ...
    public static final String HTTP_AUTHENTICATION_FACTORY_ITEM = Ids.build(Ids.ELYTRON_HTTP_AUTHENTICATION_FACTORY,
            Ids.ITEM);
    ...
    public static final String KERBEROS_SECURITY_FACTORY_ITEM = Ids.build(Ids.ELYTRON_KERBEROS_SECURITY_FACTORY,
            Ids.ITEM);
    ...
    public static final String MECHANISM_PROVIDER_FILTERING_SASL_SERVER_FACTORY_ITEM = Ids.build(
            Ids.ELYTRON_MECHANISM_PROVIDER_FILTERING_SASL_SERVER_FACTORY, Ids.ITEM);
    ...
    public static final String PROVIDER_HTTP_SERVER_MECHANISM_FACTORY_ITEM = Ids.build(
            Ids.ELYTRON_PROVIDER_HTTP_SERVER_MECHANISM_FACTORY, Ids.ITEM);
    public static final String PROVIDER_LOADER_ITEM = "elytron-provider-loader-item";
    public static final String PROVIDER_SASL_SERVER_FACTORY_ITEM = Ids.build(Ids.ELYTRON_PROVIDER_SASL_SERVER_FACTORY,
            Ids.ITEM);
    ...
    public static final String REGEX_PRINCIPAL_TRANSFORMER_ITEM = Ids.build(Ids.ELYTRON_REGEX_PRINCIPAL_TRANSFORMER,
            Ids.ITEM);
    public static final String REGEX_VALIDATING_PRINCIPAL_TRANSFORMER_ITEM = Ids.build(
            Ids.ELYTRON_REGEX_VALIDATING_PRINCIPAL_TRANSFORMER, Ids.ITEM);
    ...
    public static final String SASL_AUTHENTICATION_FACTORY_ITEM = Ids.build(Ids.ELYTRON_SASL_AUTHENTICATION_FACTORY,
            Ids.ITEM);
    ...
    public static final String SERVICE_LOADER_HTTP_SERVER_MECHANISM_FACTORY_ITEM = Ids.build(
            Ids.ELYTRON_SERVICE_LOADER_HTTP_SERVER_MECHANISM_FACTORY, Ids.ITEM);
    public static final String SERVICE_LOADER_SASL_SERVER_FACTORY_ITEM = Ids.build(
            Ids.ELYTRON_SERVICE_LOADER_SASL_SERVER_FACTORY,
            Ids.ITEM);
    ...
    public static final String AGG_HTTP_TRY_UPDATE = Ids.build(AGGREGATE_HTTP_SERVER_MECHANISM_FACTORY_PREFIX,
            TRY_UPDATE,
            Random.name());
    ...
    public static final String CONF_HTTP_UPDATE = Ids.build(CONFIGURABLE_HTTP_SERVER_MECHANISM_FACTORY_PREFIX,
            CrudConstants.UPDATE, Random.name());
    public static final String CONF_HTTP_TRY_UPDATE = Ids.build(CONFIGURABLE_HTTP_SERVER_MECHANISM_FACTORY_PREFIX,
            TRY_UPDATE,
            Random.name());
    ...
    public static final String HTTP_AUTH_UPDATE = Ids.build(HTTP_AUTHENTICATION_FACTORY_PREFIX, CrudConstants.UPDATE,
            Random.name());
    public static final String HTTP_AUTH_TRY_UPDATE = Ids.build(HTTP_AUTHENTICATION_FACTORY_PREFIX, TRY_UPDATE,
            Random.name());
    ...
    public static final String MECH_RE_CONF_CREATE = Ids.build(MECHANISM_REALM_CONFIGURATION_PREFIX,
            CrudConstants.CREATE,
            Random.name());
    public static final String MECH_RE_CONF_UPDATE = Ids.build(MECHANISM_REALM_CONFIGURATION_PREFIX,
    ...
    public static final String MECH_RE_CONF_DELETE = Ids.build(MECHANISM_REALM_CONFIGURATION_PREFIX,
    ...
    public static final String CONF_SASL_CREATE = Ids.build(CONFIGURABLE_SASL_SERVER_FACTORY_PREFIX,
            CrudConstants.CREATE,
            Random.name());
    public static final String CONF_SASL_UPDATE = Ids.build(CONFIGURABLE_SASL_SERVER_FACTORY_PREFIX,
            CrudConstants.UPDATE,
            Random.name());
    public static final String CONF_SASL_DELETE = Ids.build(CONFIGURABLE_SASL_SERVER_FACTORY_PREFIX,
            CrudConstants.DELETE,
            Random.name());
    ...
    public static final String AGG_PRI_TRANS_CREATE = Ids.build(AGGREGATE_PRINCIPAL_TRANSFORMER_PREFIX,
            CrudConstants.CREATE,
            Random.name());
    public static final String AGG_PRI_TRANS_UPDATE = Ids.build(AGGREGATE_PRINCIPAL_TRANSFORMER_PREFIX,
            CrudConstants.UPDATE,
            Random.name());
    public static final String AGG_PRI_TRANS_TRY_UPDATE = Ids.build(AGGREGATE_PRINCIPAL_TRANSFORMER_PREFIX, TRY_UPDATE,
            Random.name());
    public static final String AGG_PRI_TRANS_DELETE = Ids.build(AGGREGATE_PRINCIPAL_TRANSFORMER_PREFIX,
            CrudConstants.DELETE,
            Random.name());
    ...
    public static final String CHA_PRI_TRANS_CREATE = Ids.build(CHAINED_PRINCIPAL_TRANSFORMER_PREFIX,
            CrudConstants.CREATE,
            Random.name());
    public static final String CHA_PRI_TRANS_UPDATE = Ids.build(CHAINED_PRINCIPAL_TRANSFORMER_PREFIX,
            CrudConstants.UPDATE,
            Random.name());
    public static final String CHA_PRI_TRANS_DELETE = Ids.build(CHAINED_PRINCIPAL_TRANSFORMER_PREFIX,
            CrudConstants.DELETE,
            Random.name());
    ...
    public static final String CONS_PRI_TRANS_CREATE = Ids.build(CONSTANT_PRINCIPAL_TRANSFORMER_PREFIX,
            CrudConstants.CREATE,
            Random.name());
    public static final String CONS_PRI_TRANS_UPDATE = Ids.build(CONSTANT_PRINCIPAL_TRANSFORMER_PREFIX,
            CrudConstants.UPDATE,
            Random.name());
    public static final String CONS_PRI_TRANS_UPDATE2 = Ids.build("cons-pri-trans2", CrudConstants.UPDATE,
            Random.name());
    public static final String CONS_PRI_TRANS_UPDATE3 = Ids.build("cons-pri-trans3", CrudConstants.UPDATE,
            Random.name());
    public static final String CONS_PRI_TRANS_UPDATE4 = Ids.build("cons-pri-trans4", CrudConstants.UPDATE,
            Random.name());
    public static final String CONS_PRI_TRANS_UPDATE5 = Ids.build("cons-pri-trans5", CrudConstants.UPDATE,
            Random.name());
    public static final String CONS_PRI_TRANS_UPDATE6 = Ids.build("cons-pri-trans6", CrudConstants.UPDATE,
            Random.name());
    public static final String CONS_PRI_TRANS_UPDATE7 = Ids.build("cons-pri-trans7", CrudConstants.UPDATE,
            Random.name());
    public static final String CONS_PRI_TRANS_UPDATE8 = Ids.build("cons-pri-trans8", CrudConstants.UPDATE,
            Random.name());
    public static final String CONS_PRI_TRANS_DELETE = Ids.build(CONSTANT_PRINCIPAL_TRANSFORMER_PREFIX,
            CrudConstants.DELETE,
            Random.name());
    ...
    public static final String CUST_PRI_TRANS_CREATE = Ids.build(CUSTOM_PRINCIPAL_TRANSFORMER_PREFIX,
            CrudConstants.CREATE,
            Random.name());
    public static final String CUST_PRI_TRANS_UPDATE = Ids.build(CUSTOM_PRINCIPAL_TRANSFORMER_PREFIX,
            CrudConstants.UPDATE,
            Random.name());
    public static final String CUST_PRI_TRANS_DELETE = Ids.build(CUSTOM_PRINCIPAL_TRANSFORMER_PREFIX,
            CrudConstants.DELETE,
            Random.name());
    ...
    public static final String REG_PRI_TRANS_CREATE = Ids.build(REGEX_PRINCIPAL_TRANSFORMER_PREFIX,
            CrudConstants.CREATE,
            Random.name());
    public static final String REG_PRI_TRANS_UPDATE = Ids.build(REGEX_PRINCIPAL_TRANSFORMER_PREFIX,
            CrudConstants.UPDATE,
            Random.name());
    public static final String REG_PRI_TRANS_TRY_UPDATE = Ids.build(REGEX_PRINCIPAL_TRANSFORMER_PREFIX, TRY_UPDATE,
            Random.name());
    public static final String REG_PRI_TRANS_DELETE = Ids.build(REGEX_PRINCIPAL_TRANSFORMER_PREFIX,
            CrudConstants.DELETE,
            Random.name());
    ...
    public static final String REGV_PRI_TRANS_UPDATE = Ids.build(REGEX_VALIDATING_PRINCIPAL_TRANSFORMER_PREFIX,
            CrudConstants.UPDATE, Random.name());
    public static final String REGV_PRI_TRANS_TRY_UPDATE = Ids.build(REGEX_VALIDATING_PRINCIPAL_TRANSFORMER_PREFIX,
            TRY_UPDATE,
            Random.name());
    ...
    public static final String ADD_PRE_CREATE = Ids.build(ADD_PREFIX_ROLE_MAPPER_PREFIX, CrudConstants.CREATE,
            Random.name());
    public static final String ADD_PRE_UPDATE = Ids.build(ADD_PREFIX_ROLE_MAPPER_PREFIX, CrudConstants.UPDATE,
            Random.name());
    public static final String ADD_PRE_DELETE = Ids.build(ADD_PREFIX_ROLE_MAPPER_PREFIX, CrudConstants.DELETE,
            Random.name());
    ...
    public static final String ADD_SUF_CREATE = Ids.build(ADD_SUFFIX_ROLE_MAPPER_PREFIX, CrudConstants.CREATE,
            Random.name());
    public static final String ADD_SUF_UPDATE = Ids.build(ADD_SUFFIX_ROLE_MAPPER_PREFIX, CrudConstants.UPDATE,
            Random.name());
    public static final String ADD_SUF_DELETE = Ids.build(ADD_SUFFIX_ROLE_MAPPER_PREFIX, CrudConstants.DELETE,
            Random.name());
    ...
    public static final String AGG_ROLE_CREATE = Ids.build(AGGREGATE_ROLE_MAPPER_PREFIX, CrudConstants.CREATE,
            Random.name());
    public static final String AGG_ROLE_UPDATE = Ids.build(AGGREGATE_ROLE_MAPPER_PREFIX, CrudConstants.UPDATE,
            Random.name());
    public static final String AGG_ROLE_DELETE = Ids.build(AGGREGATE_ROLE_MAPPER_PREFIX, CrudConstants.DELETE,
            Random.name());
    ...
    public static final String CON_ROLE_CREATE = Ids.build(CONSTANT_ROLE_MAPPER_PREFIX, CrudConstants.CREATE,
            Random.name());
    public static final String CON_ROLE_UPDATE = Ids.build(CONSTANT_ROLE_MAPPER_PREFIX, CrudConstants.UPDATE,
            Random.name());
    public static final String CON_ROLE_DELETE = Ids.build(CONSTANT_ROLE_MAPPER_PREFIX, CrudConstants.DELETE,
            Random.name());
    ...
    public static final String LOG_ROLE_CREATE = Ids.build(LOGICAL_ROLE_MAPPER_PREFIX, CrudConstants.CREATE,
            Random.name());
    public static final String LOG_ROLE_UPDATE = Ids.build(LOGICAL_ROLE_MAPPER_PREFIX, CrudConstants.UPDATE,
            Random.name());
    public static final String LOG_ROLE_DELETE = Ids.build(LOGICAL_ROLE_MAPPER_PREFIX, CrudConstants.DELETE,
            Random.name());
    ...
    public static final String PERM_MAP_CREATE = Ids.build(PERMISSION_MAPPINGS_PREFIX, CrudConstants.CREATE,
            Random.name());
    public static final String PERM_MAP_UPDATE = Ids.build(PERMISSION_MAPPINGS_PREFIX, CrudConstants.UPDATE,
            Random.name());
    public static final String PERM_MAP_DELETE = Ids.build(PERMISSION_MAPPINGS_PREFIX, CrudConstants.DELETE,
            Random.name());
    ...
    public static final String X500_PRI_CREATE = Ids.build(X500_ATTRIBUTE_PRINCIPAL_DECODER_PREFIX,
            CrudConstants.CREATE,
            Random.name());
    public static final String X500_PRI_UPDATE = Ids.build(X500_ATTRIBUTE_PRINCIPAL_DECODER_PREFIX,
            CrudConstants.UPDATE,
            Random.name());
    public static final String X500_PRI_DELETE = Ids.build(X500_ATTRIBUTE_PRINCIPAL_DECODER_PREFIX,
            CrudConstants.DELETE,
            Random.name());
    ...
    public static final String SIMP_ROLE_CREATE = Ids.build(SIMPLE_ROLE_DECODER_PREFIX, CrudConstants.CREATE,
            Random.name());
    public static final String SIMP_ROLE_UPDATE = Ids.build(SIMPLE_ROLE_DECODER_PREFIX, CrudConstants.UPDATE,
            Random.name());
    public static final String SIMP_ROLE_DELETE = Ids.build(SIMPLE_ROLE_DECODER_PREFIX, CrudConstants.DELETE,
            Random.name());
    ...
    public static final String FILT_ST_CREATE = Ids.build(FILTERING_KEY_STORE_PREFIX, CrudConstants.CREATE,
            Random.name());
    public static final String FILT_ST_UPDATE = Ids.build(FILTERING_KEY_STORE_PREFIX, CrudConstants.UPDATE,
            Random.name());
    public static final String FILT_ST_DELETE = Ids.build(FILTERING_KEY_STORE_PREFIX, CrudConstants.DELETE,
            Random.name());
    ...
    public static final String LDAPKEY_ST_CREATE = Ids.build(LDAP_KEY_STORE_PREFIX, CrudConstants.CREATE,
            Random.name());
    public static final String LDAPKEY_ST_UPDATE = Ids.build(LDAP_KEY_STORE_PREFIX, CrudConstants.UPDATE,
            Random.name());
    ...
    public static final String LDAPKEY_ST_DELETE = Ids.build(LDAP_KEY_STORE_PREFIX, CrudConstants.DELETE,
            Random.name());
    ...
    public static final String AGG_PRV_CREATE = Ids.build(AGGREGATE_PROVIDERS_PREFIX, CrudConstants.CREATE,
            Random.name());
    public static final String AGG_PRV_UPDATE = Ids.build(AGGREGATE_PROVIDERS_PREFIX, CrudConstants.UPDATE,
            Random.name());
    public static final String AGG_PRV_DELETE = Ids.build(AGGREGATE_PROVIDERS_PREFIX, CrudConstants.DELETE,
            Random.name());
    ...
    public static final String CLI_SSL_CREATE = Ids.build(CLIENT_SSL_CONTEXT_PREFIX, CrudConstants.CREATE,
            Random.name());
    public static final String CLI_SSL_UPDATE = Ids.build(CLIENT_SSL_CONTEXT_PREFIX, CrudConstants.UPDATE,
            Random.name());
    public static final String CLI_SSL_DELETE = Ids.build(CLIENT_SSL_CONTEXT_PREFIX, CrudConstants.DELETE,
            Random.name());
    ...
    public static final String PROV_LOAD_CREATE = Ids.build(PROVIDER_LOADER_PREFIX, CrudConstants.CREATE,
            Random.name());
    public static final String PROV_LOAD_UPDATE = Ids.build(PROVIDER_LOADER_PREFIX, CrudConstants.UPDATE,
            Random.name());
    ...
    public static final String PROV_LOAD_DELETE = Ids.build(PROVIDER_LOADER_PREFIX, CrudConstants.DELETE,
            Random.name());
    ...
    public static final String SRV_SSL_CREATE = Ids.build(SEREVR_SSL_CONTEXT_PREFIX, CrudConstants.CREATE,
            Random.name());
    public static final String SRV_SSL_UPDATE = Ids.build(SEREVR_SSL_CONTEXT_PREFIX, CrudConstants.UPDATE,
            Random.name());
    public static final String SRV_SSL_DELETE = Ids.build(SEREVR_SSL_CONTEXT_PREFIX, CrudConstants.DELETE,
            Random.name());
    ...
    public static final String TRU_MAN_CRL_CRT = Ids.build(TRUST_MANAGER_CRL_PREFIX, CrudConstants.CREATE,
            Random.name());
    public static final String TRU_MAN_CRL_UPD = Ids.build(TRUST_MANAGER_CRL_PREFIX, CrudConstants.UPDATE,
            Random.name());
    public static final String TRU_MAN_CRL_DEL = Ids.build(TRUST_MANAGER_CRL_PREFIX, CrudConstants.DELETE,
            Random.name());
    ...
    public static final String AUT_CT_CREATE = Ids.build(AUTHENTICATION_CONTEXT_PREFIX, CrudConstants.CREATE,
            Random.name());
    public static final String AUT_CT_UPDATE = Ids.build(AUTHENTICATION_CONTEXT_PREFIX, CrudConstants.UPDATE,
            Random.name());
    public static final String AUT_CT_UPDATE2 = Ids.build("auth-ct-2", CrudConstants.UPDATE, Random.name());
    public static final String AUT_CT_DELETE = Ids.build(AUTHENTICATION_CONTEXT_PREFIX, CrudConstants.DELETE,
            Random.name());

    // authentication-context match-rules
    public static final String AUT_CT_MR_CREATE = Ids.build(AUTHENTICATION_CONTEXT_MATCH_RULE_PREFIX,
            CrudConstants.CREATE,
            Random.name());
    public static final String AUT_CT_MR_UPDATE = Ids.build(AUTHENTICATION_CONTEXT_MATCH_RULE_PREFIX,
            CrudConstants.UPDATE,
            Random.name());
    public static final String AUT_CT_MR_DELETE = Ids.build(AUTHENTICATION_CONTEXT_MATCH_RULE_PREFIX,
            CrudConstants.DELETE,
            Random.name());
    ...
    public static final String AGG_SEC_CREATE = Ids.build(AGGREGATOR_SECURITY_EVENT_LISTENER_PREFIX,
            CrudConstants.CREATE,
            Random.name());
    public static final String AGG_SEC_UPDATE = Ids.build(AGGREGATOR_SECURITY_EVENT_LISTENER_PREFIX,
            CrudConstants.UPDATE,
            Random.name());
    public static final String AGG_SEC_DELETE = Ids.build(AGGREGATOR_SECURITY_EVENT_LISTENER_PREFIX,
            CrudConstants.DELETE,
            Random.name());
    ...
    public static final String CMO_RLM_CREATE = Ids.build(CUSTOM_MODIFIABLE_REALM_PREFIX, CrudConstants.CREATE,
            Random.name());
    public static final String CMO_RLM_UPDATE = Ids.build(CUSTOM_MODIFIABLE_REALM_PREFIX, CrudConstants.UPDATE,
            Random.name());
    public static final String CMO_RLM_DELETE = Ids.build(CUSTOM_MODIFIABLE_REALM_PREFIX, CrudConstants.DELETE,
            Random.name());
    ...
    public static final String FILESYS_RLM_CREATE = Ids.build(FILESYSTEM_REALM_PREFIX, CrudConstants.CREATE,
            Random.name());
    public static final String FILESYS_RLM_UPDATE = Ids.build(FILESYSTEM_REALM_PREFIX, CrudConstants.UPDATE,
            Random.name());
    ...
    public static final String FILESYS_RLM_DELETE = Ids.build(FILESYSTEM_REALM_PREFIX, CrudConstants.DELETE,
            Random.name());
    ...
    public static final String PROP_RLM_CREATE = Ids.build(PROPERTIES_REALM_PREFIX, CrudConstants.CREATE,
            Random.name());
    public static final String PROP_RLM_UPDATE = Ids.build(PROPERTIES_REALM_PREFIX, CrudConstants.UPDATE,
            Random.name());
    public static final String PROP_RLM_DELETE = Ids.build(PROPERTIES_REALM_PREFIX, CrudConstants.DELETE,
            Random.name());
    ...
    public static final String CON_RM_CREATE = Ids.build(CONSTANT_REALM_MAPPER_PREFIX, CrudConstants.CREATE,
            Random.name());
    public static final String CON_RM_UPDATE = Ids.build(CONSTANT_REALM_MAPPER_PREFIX, CrudConstants.UPDATE,
            Random.name());
    public static final String CON_RM_DELETE = Ids.build(CONSTANT_REALM_MAPPER_PREFIX, CrudConstants.DELETE,
            Random.name());
    ...
    public static final String CUS_RM_CREATE = Ids.build(CUSTOM_REALM_MAPPER_PREFIX, CrudConstants.CREATE,
            Random.name());
    public static final String CUS_RM_UPDATE = Ids.build(CUSTOM_REALM_MAPPER_PREFIX, CrudConstants.UPDATE,
            Random.name());
    public static final String CUS_RM_DELETE = Ids.build(CUSTOM_REALM_MAPPER_PREFIX, CrudConstants.DELETE,
            Random.name());
