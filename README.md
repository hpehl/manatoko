...
The biggest advantage of this approach is that it is very easy to run UI tests in a CI environment like GitHub Actions (like this repository [does](.github/workflows/ci.yml)).
