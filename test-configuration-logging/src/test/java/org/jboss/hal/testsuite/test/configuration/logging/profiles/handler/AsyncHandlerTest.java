...
class AsyncHandlerTest extends AbstractAsyncHandlerTest {
    ...
    static void setupModel() throws Exception {
        ...
        operations.add(LoggingFixtures.LoggingProfile.asyncHandlerAddress(LOGGING_PROFILE, ASYNC_HANDLER_UPDATE),
                Values.of(QUEUE_LENGTH, 10)).assertSuccess();
        operations.add(LoggingFixtures.LoggingProfile.asyncHandlerAddress(LOGGING_PROFILE, ASYNC_HANDLER_DELETE),
                Values.of(QUEUE_LENGTH, 10)).assertSuccess();
    }
