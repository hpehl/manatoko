...
import org.jboss.hal.testsuite.test.configuration.logging.AbstractXmlFormatterTest;
...
import static org.jboss.hal.testsuite.fixtures.LoggingFixtures.XmlFormatter.XML_FORMATTER_DELETE;
import static org.jboss.hal.testsuite.fixtures.LoggingFixtures.XmlFormatter.XML_FORMATTER_RESET;
import static org.jboss.hal.testsuite.fixtures.LoggingFixtures.XmlFormatter.XML_FORMATTER_UPDATE;

@Manatoko
@Testcontainers
class XmlFormatterTest extends AbstractXmlFormatterTest {
    ...
    static void setupModel() throws Exception {
        ...
        ops.add(LoggingFixtures.LoggingProfile.xmlFormatterAddress(LOGGING_PROFILE, XML_FORMATTER_UPDATE))
                .assertSuccess();
        ops.add(LoggingFixtures.LoggingProfile.xmlFormatterAddress(LOGGING_PROFILE, XML_FORMATTER_RESET),
                Values.of(RECORD_DELIMITER, Random.name())).assertSuccess();
        ops.add(LoggingFixtures.LoggingProfile.xmlFormatterAddress(LOGGING_PROFILE, XML_FORMATTER_DELETE))
                .assertSuccess();
    }
