 ...
 */
package org.jboss.hal.testsuite.test.configuration.logging.profiles.handler;
...
import org.jboss.hal.testsuite.test.configuration.logging.AbstractPeriodicSizeHandlerTest;
...
@Manatoko
@Testcontainers
class PeriodicSizeHandlerTest extends AbstractPeriodicSizeHandlerTest {
    ...
    static void setupModel() throws Exception {
        ...
        ops.add(LoggingFixtures.LoggingProfile.periodicSizeHandlerAddress(LOGGING_PROFILE, PERIODIC_SIZE_HANDLER_READ),
                Values.of(FILE, file.clone()).and(SUFFIX, SUFFIX_VALUE)).assertSuccess();
        ops.add(LoggingFixtures.LoggingProfile.periodicSizeHandlerAddress(LOGGING_PROFILE,
                PERIODIC_SIZE_HANDLER_UPDATE),
                Values.of(FILE, file.clone()).and(SUFFIX, SUFFIX_VALUE)).assertSuccess();
        ops.add(LoggingFixtures.LoggingProfile.periodicSizeHandlerAddress(LOGGING_PROFILE,
                PERIODIC_SIZE_HANDLER_DELETE),
                Values.of(FILE, file.clone()).and(SUFFIX, SUFFIX_VALUE)).assertSuccess();
    }
    ...
    protected Address periodicSizeHandlerAddress(String name) {
        return LoggingFixtures.LoggingProfile.periodicSizeHandlerAddress(LOGGING_PROFILE, name);
    }
