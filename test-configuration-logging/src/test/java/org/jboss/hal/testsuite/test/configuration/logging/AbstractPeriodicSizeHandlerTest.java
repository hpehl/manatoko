...
import static org.jboss.hal.testsuite.fixtures.LoggingFixtures.PeriodicSizeHandler;
...
public abstract class AbstractPeriodicSizeHandlerTest {
    ...
    void delete() throws Exception {
        crud.delete(periodicSizeHandlerAddress(
                PeriodicSizeHandler.PERIODIC_SIZE_HANDLER_DELETE), table,
                PeriodicSizeHandler.PERIODIC_SIZE_HANDLER_DELETE);
    }
}
