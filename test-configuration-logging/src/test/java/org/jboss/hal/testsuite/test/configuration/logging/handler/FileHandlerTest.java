 ...
 */
package org.jboss.hal.testsuite.test.configuration.logging.handler;
...
class FileHandlerTest extends AbstractFileHandlerTest {
    ...
    static void setupModel() throws Exception {
        ...
        ops.add(LoggingFixtures.FileHandler.fileHandlerAddress(FILE_HANDLER_READ), Values.of(FILE, file.clone()))
                .assertSuccess();
        ops.add(LoggingFixtures.FileHandler.fileHandlerAddress(FILE_HANDLER_UPDATE), Values.of(FILE, file.clone()))
                .assertSuccess();
        ops.add(LoggingFixtures.FileHandler.fileHandlerAddress(FILE_HANDLER_DELETE), Values.of(FILE, file.clone()))
                .assertSuccess();
    }
