...
public class AddLocalSocketBinding extends SocketBindingCommand {
     ...
     * <code>standard-sockets</code> and default group for domain mode is <code>full-sockets</code>. <code>full-sockets</code>
     * is <b>default socket group only for all started servers</b> in default server configuration (<code>server-one</code> and
     * <code>server-two</code>).
     */
