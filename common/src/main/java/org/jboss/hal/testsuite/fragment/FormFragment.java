...
public class FormFragment {
    ...
    /**
     * Waits until the blank section is visible. If this form is part of a tab pane, make sure to
     * {@linkplain TabsFragment#select(String) select} the tab first!
     */
    ...
    /**
     * Waits until the read-only section is visible. If this form is part of a tab pane, make sure to
     * {@linkplain TabsFragment#select(String) select} the tab first!
     */
    public void view() {
    ...
    public void textByLabel(String labelContent, String value) {
        ...
        WebElement inputElement = browser.findElement(
    ...
    /**
     * Enters text with firing additional change event if console does not register the original one. <b> Use only as a dirty
     * workaround when {@link #text(String, String)} is not working properly via Selenium!</b>
     *
    ...
    public FormFragment flip(String name, boolean value) {
        ...
        if (inputValue != value) {
            WebElement switchElement = formGroup.findElement(By.cssSelector(".bootstrap-switch-label"));
            try {
