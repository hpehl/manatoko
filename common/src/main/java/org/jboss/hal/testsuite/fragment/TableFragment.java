...
public class TableFragment {
    ...
    /**
     * Binds the forms to the table. Calling {@link TableFragment#select(String)} will trigger {@link FormFragment#view()}.
     */
    ...
    /**
     * Binds the form to the table. Calling {@link TableFragment#select(String)} will trigger {@link FormFragment#view()}.
     */
    ...
    /**
     * Binds the blank form to the table. Calling {@link TableFragment#select(String)} will trigger
     * {@link FormFragment#viewBlank()}.
     */
