...
public class AvailablePortFinder {
    ...
    /**
     * Returns the {@link Set} of currently unused port numbers ({@link Integer}). This method is identical to
    ...
    /**
     * Returns the {@link Set} of currently not used port numbers ({@link Integer}) between the specified port range.
     *
