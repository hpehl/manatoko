 ...
 */
package org.jboss.hal.manatoko.fragment.finder;
...
public class ColumnFragment {
    ...
    /**
     * Shortcut for {@code action("<columnId>-add").click()}. Expects that the action opens an add resource dialog and returns
     * it.
     */
    ...
    /**
     * Initializes the column with its ID. Must not be called manually. Instead use {@link FinderFragment#column(String)} which
