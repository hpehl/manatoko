 ...
 */
package org.jboss.hal.manatoko.creaper;
...
import org.jboss.hal.manatoko.dmr.ModelNodeUtils;
...
public class ResourceVerifier {
     ...
     * @param innerObjectValue The inner object value
     */
    public ResourceVerifier verifyListAttributeDoesNotContainsSingleValueOfList(String listAttribute, String objectAttribute,
            String objectValue,
            String innerListAttribute, String innerObjectAttribute, String innerObjectValue) throws Exception {
        waitFor(() -> {
            ModelNodeResult actualResult = ops.readAttribute(address, listAttribute);
