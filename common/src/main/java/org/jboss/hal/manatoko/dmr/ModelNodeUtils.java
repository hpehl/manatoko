 ...
 */
package org.jboss.hal.manatoko.dmr;
...
public class ModelNodeUtils {
     ...
     * filterAttribute=filterValue, then it gets the objectName and compares the inner object with the value object parameter.
     * An example is /subsystem=elytron/jdbc-realm=*, the principal-query of type LIST, contains an sql attribute and
     * bcrypt-mapper of type OBJECT.
     *
     * @param list list to be checked
    ...
    /**
     * Verifies if an attribute is undefined in a top LIST attribute, filtered by filterAttribute=filterValue, then it checks if
     * the objectName attribute is defined. An example is /subsystem=elytron/jdbc-realm=*, the principal-query of type LIST,
     * contains an sql attribute and bcrypt-mapper of type OBJECT.
     *
     * @param list list to be checked
     * @param filterAttribute the attribute name to filter
     * @param filterValue the attribute value to filter
