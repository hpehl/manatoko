...
class ResourceDescription {
    ...
    private static final Logger logger = LoggerFactory.getLogger(ResourceDescription.class);
    ...
    ResourceDescription(Address address, OnlineManagementClient client) {
        ...
        try {
            ...
            logger.error("Cannot read resource description for {}: {}", address, e.getMessage(), e);
     ...
     *
     * <p>
     * Throws a {@link NoSuchElementException} if the attribute is not found or doesn't have a default value.
     * </p>
     */
