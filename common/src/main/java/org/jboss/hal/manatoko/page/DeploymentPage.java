...
import org.jboss.hal.manatoko.fragment.DropdownFragment;
...
import org.jboss.hal.manatoko.fragment.finder.ItemFragment;
...
public class DeploymentPage extends BasePage {
    ...
    public DeploymentPage callActionOnDeploymentInServerGroup(String serverGroupName, String deploymentName,
            String actionName) {
    ...
    public DeploymentPage checkAndSelectDefaultActionOnServerGroupDeployment(String serverGroupName,
