...
public abstract class AbstractBehindTest {
    ...
    @Test
    void changeQueueSize() throws Exception {
        crud.update(storeAddress().and(WRITE, BEHIND), form(page), "modification-queue-size", Random.number());
    }

    protected abstract Address storeAddress();

    protected abstract FormFragment form(ScatteredCachePage page);
}
